...
This two-steps gambit (Blackmar & Diemer) may be reached by the Queen Pawn Game (D00), the Scandinavian Defense (B01) or even through an Indian Defense (A45) with **2. Nc3 d5 3. e4**
<br><div align="center">
...
> - Black objective is to break White's initiative and strive for exchanging the pieces and reach a better end game<br>
> - Black may avoid the gambit by playing the [Caro-Kann Defense](../../e4_openings/e4_c6_Caro_Kann.md) (+0.3) or the [French Defense](../../e4_openings/e4_e6_French.md) (+0.3)
...
>     - Black should not take here and protect e4 with **... Nf6** (attacking the center with **... e5** leads to the drawback of exchanging the white bishop with the knight) : the idea is to try exchanging pieces with an advantage in the end game<br>
> <br><div align="center">
...
- The pawn taking move represents 78% of masters game, but Black still has counterplay in refusing the f3 pawn: 
    ...
    - refuse with ... e3 (+0.4) : Langeheinicke Defense : also a side move, but allowing White to recover a good position similar to a [Caro-Kann](../../e4_openings/e4_c6_Caro_Kann.md) variation
<br>
...
- The risky [**5.Qxf3**](#_accepted_Qxf3_) (-1.4) : leads to lots of traps for Black, but likely to lose in a tournament game if Black is prepared
