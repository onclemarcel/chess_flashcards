...
*Online: bullet/blitz, 1800+ — 173.1 M games. Masters: 501 k games. [Open in the explorer](https://lichess.org/analysis/standard/rnbqkbnr/pp1ppppp/8/2p5/4P3/5N2/PPPP1PPP/RNBQKB1R_b_KQkq_-_1_2#explorer) — updated 2026-09-07*
<!-- lichess-stats:end -->

Masters are close to evenly split three ways here, and each answer opens into its own vast body of theory:

* [**2... d6**](https://github.com/onclemarcel/chess_flashcards/blob/main/e4_openings/B50_Sicilian_d6_Open.md) (+0.3, 46.1% masters): prepares ... Nf6 without allowing e5 tricks, keeping options open between the [*Najdorf*, *Classical*, and *Dragon* families](https://github.com/onclemarcel/chess_flashcards/blob/main/e4_openings/B56_Sicilian_Classical_Variation.md#_a6_) depending on how the game continues after 3. d4 cxd4 4. Nxd4 Nf6 5. Nc3.
