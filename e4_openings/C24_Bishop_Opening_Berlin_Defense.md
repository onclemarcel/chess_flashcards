...
# C24 Bishop's Opening: Berlin Defense <br> 1. e4 e5 2. Bc4 Nf6 #

Spun off from [`C23_Bishop_Opening.md`](https://github.com/onclemarcel/chess_flashcards/blob/main/e4_openings/C23_Bishop_Opening.md)'s own candidate list — masters' overwhelming preference there (83.2% of masters games). **A "wrong root code" fix**: this exact position was previously described in the C23 card itself, but the live explorer already tags it its own code, **C24**, the *Berlin Defense* — the same name reused from the Ruy Lopez, unrelated to it. By attacking e4 immediately, Black denies White the leisurely development the Bishop's Opening usually offers.

<a name="_initial_move_"></a>

[![2... Nf6](https://backscattering.de/web-boardimage/board.svg?fen=rnbqkb1r/pppp1ppp/5n2/4p3/2B1P3/8/PPPP1PPP/RNBQK1NR&lastMove=g8f6&coordinates=true&size=320)](https://lichess.org/analysis/standard/rnbqkb1r/pppp1ppp/5n2/4p3/2B1P3/8/PPPP1PPP/RNBQK1NR_w_KQkq_-_2_3)
...
*Online: bullet/blitz, 1800+ — 6.5 M games. Masters: 7.8 k games. [Open in the explorer](https://lichess.org/analysis/standard/rnbqkb1r/pppp1ppp/5n2/4p3/2B1P3/8/PPPP1PPP/RNBQK1NR_w_KQkq_-_2_3#explorer) — updated 2026-09-09*
<!-- lichess-stats:end -->

> [!NOTE]
> **3. d3** is masters' near-unanimous reply here (86.4% of masters games) — the *Modern Bishop's Opening*, quietly defending e4 and preparing a slow build-up — but only their top choice online by a much smaller margin (36.9%), where **3. Nc3**, **3. Nf3**, and even the immediate **3. d4** are all tried in real numbers. This card and [C50 Italian](https://github.com/onclemarcel/chess_flashcards/blob/main/e4_openings/C50_Italian.md) converge on the same 3. d3 tabiya whenever Black meets either opening with ... Nf6 — see below (this exact position carries no ECO tag of its own; `eco.md` doesn't list it, and the live explorer returns `opening=None` — kept here rather than in a separate file since its own nearest live-tagged ancestor is this card's own root, one ply back).

* [**3. d3**](#_d3_) (+0.1, 86.4% masters): defends e4 and keeps the position flexible — masters' overwhelming preference. See below.
...
* **3. f4**: live-tagged the *Greco Gambit* — a real database rarity (2 masters games), Stockfish rating it a real edge for Black (−0.8), not built out further here.
...
## 3. d3 — Modern Bishop's Opening

[![3. d3](https://backscattering.de/web-boardimage/board.svg?fen=rnbqkb1r/pppp1ppp/5n2/4p3/2B1P3/3P4/PPP2PPP/RNBQK1NR&lastMove=d2d3&coordinates=true&size=320)](https://lichess.org/analysis/standard/rnbqkb1r/pppp1ppp/5n2/4p3/2B1P3/3P4/PPP2PPP/RNBQK1NR_b_KQkq_-_0_3)
...
<!-- lichess-stats:start fen="rnbqkb1r/pppp1ppp/5n2/4p3/2B1P3/3P4/PPP2PPP/RNBQK1NR b KQkq - 0 3" db="lichess,masters" speeds="bullet,blitz" ratings="1800,2000,2200,2500" moves="6" -->
| Move | Online | W/D/B | Masters | W/D/B | |
| :--- | ---: | :--- | ---: | :--- | :-- |
| Bc5 | 827 k (34.5%) | ⬜⬜⬜⬜⬜⬛⬛⬛⬛⬛ 50/4/46 | 815 (12.2%) | ⬜⬜⬜⬜🟫🟫🟫🟫⬛⬛ 38/40/22 |  |
| Nc6 | 527 k (22.0%) | ⬜⬜⬜⬜⬜⬛⬛⬛⬛⬛ 49/5/46 | 2.8 k (42.0%) | ⬜⬜⬜⬜🟫🟫🟫🟫⬛⬛ 34/42/24 |  |
| c6 | 448 k (18.7%) | ⬜⬜⬜⬜⬜⬛⬛⬛⬛⬛ 47/5/49 | 2.8 k (42.1%) | ⬜⬜⬜🟫🟫🟫🟫🟫⬛⬛ 30/50/20 |  |
| d5 | 204 k (8.5%) | ⬜⬜⬜⬜⬜⬛⬛⬛⬛⬛ 48/4/47 | 60 (0.9%) | ⬜⬜⬜⬜⬜🟫🟫🟫⬛⬛ 53/25/22 |  |
| Be7 | 141 k (5.9%) | ⬜⬜⬜⬜⬜⬛⬛⬛⬛⬛ 50/5/45 | 143 (2.1%) | ⬜⬜⬜⬜🟫🟫🟫🟫⬛⬛ 44/34/22 |  |
| h6 | 127 k (5.3%) | ⬜⬜⬜⬜⬜🟫⬛⬛⬛⬛ 52/5/44 | 0 | — | ⚠ |
| d6 | 0 | — | 34 (0.5%) | ⬜⬜⬜⬜⬜🟫🟫🟫🟫⬛ 44/44/12 |  |

*Online: bullet/blitz, 1800+ — 2.4 M games. Masters: 6.7 k games. [Open in the explorer](https://lichess.org/analysis/standard/rnbqkb1r/pppp1ppp/5n2/4p3/2B1P3/3P4/PPP2PPP/RNBQK1NR_b_KQkq_-_0_3#explorer) — updated 2026-09-09*
<!-- lichess-stats:end -->

> [!NOTE]
> A genuine near-even three-way fork at master level, with no single dominant try — a good example of a tabiya that's more about transposition than a defining "main line." **c6** (42.1%) and **Nc6** (42.0%) are essentially tied for the masters' top spot, with **Bc5** a clear third (12.2%). Online the picture flips sharply: **Bc5** leads outright (34.5%), the more natural-looking developing move winning out over prophylactic choices when players aren't following theory.
...
> [!NOTE]
> [DN-3] **3. d4**, the *Ponziani Gambit* (5.8% masters, 13.0% online), opens the centre immediately instead of the quiet 3. d3, and it's perfectly sound (-0.2, barely different from 3. d3 itself) — not a dubious try. The imprecision comes one move later: after **3... exd4**, **4. e5** (attacking the knight, -0.65) is measurably worse than the simple **4. Nf3** (-0.15, recapturing the pawn back next while keeping development simple). This line is *not* built out as its own dedicated card yet (backlog); the beginner-level game below is flagged here specifically because it shows what 4. e5 actually costs in practice, move by move — not because 3. d4 itself is a mistake.

**3. d4 exd4 4. Nf3** is a genuine curiosity: `eco.md` names it the *Urusov Gambit* under this code, but the live explorer actually tags this exact position **C43** (it transposes into Petrov Defense territory, since the same position is reachable via 1. e4 e5 2. Nf3 Nf6 3. Bc4 Nxe4 4. d4-style move orders) — out of scope for this C24 card. Deeper still, **4... d5 5. exd5 Bb4+ 6. c3 Qe7** reverts to being tagged **C24** again as the *Panov Variation* (+0.2, a real database rarity — 13 masters games). Neither built out further here.
