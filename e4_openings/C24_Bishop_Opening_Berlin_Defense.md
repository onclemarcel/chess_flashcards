...
*Online: bullet/blitz, 1800+ — 6.5 M games. Masters: 7.8 k games. [Open in the explorer](https://lichess.org/analysis/standard/rnbqkb1r/pppp1ppp/5n2/4p3/2B1P3/8/PPPP1PPP/RNBQK1NR_w_KQkq_-_2_3#explorer) — updated 2026-09-03*
<!-- lichess-stats:end -->

> [!NOTE]
> **3. d3** is masters' near-unanimous reply here (86.4% of masters games) — the [**Modern Bishop's Opening**](https://github.com/onclemarcel/chess_flashcards/blob/main/e4_openings/C24_Modern_Bishops_Opening.md), quietly defending e4 and preparing a slow build-up — but only their top choice online by a much smaller margin (36.9%), where **3. Nc3**, **3. Nf3**, and even the immediate **3. d4** are all tried in real numbers. This card and [C50 Italian](https://github.com/onclemarcel/chess_flashcards/blob/main/e4_openings/C50_Italian.md) converge on the same 3. d3 tabiya whenever Black meets either opening with ... Nf6 — covered in full on its own card.
