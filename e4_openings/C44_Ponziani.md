...
# C44 Ponziani Opening <br> 1. e4 e5 2. Nf3 Nc6 3. c3 #

Spun off from [C44's own 1... Nc6 hub](https://github.com/onclemarcel/chess_flashcards/blob/main/e4_openings/C44_Nc6_King_Knight.md), where c3 already sat in the stats table (0.6% masters, 3.0% online) with no candidate bullet or card pointing to it — a genuine zero-coverage gap surfaced by a full A00-E99 ECO-code audit. Named after 18th-century Italian player Domenico Lorenzo Ponziani: rather than develop a bishop, White prepares an immediate **d4**, building a full pawn centre before Black's own knight development can pressure e4.
...
*Online: bullet/blitz, 1800+ — 3.8 M games. Masters: 1.6 k games. [Open in the explorer](https://lichess.org/analysis/standard/r1bqkbnr/pppp1ppp/2n5/4p3/4P3/2P2N2/PP1P1PPP/RNBQKB1R_b_KQkq_-_0_3#explorer) — updated 2026-08-27*
<!-- lichess-stats:end -->
...
* [**3... Nf6**](#_Nf6_) (0.0, 57.6% masters): the *Jaenisch Counterattack* — the line this card follows.
* **3... d5** (0.0, 32.0% masters): also real, striking the centre from the other side; not built out further here (backlog).
...
*Online: bullet/blitz, 1800+ — 1.7 M games. Masters: 909 games. [Open in the explorer](https://lichess.org/analysis/standard/r1bqkb1r/pppp1ppp/2n2n2/4p3/4P3/2P2N2/PP1P1PPP/RNBQKB1R_w_KQkq_-_1_4#explorer) — updated 2026-08-27*
<!-- lichess-stats:end -->
