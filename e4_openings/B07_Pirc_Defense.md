...
flowchart LR
    ...
    d6["1. e4 d6"]
    click d6 "#_initial_move_" "B00 · Pirc Defense"

    d6 --> d4[["2. d4 !<br/>+0.5"]]:::main
    click d4 "#_d4_" "B00 · Pirc Defense"

    d4 --> Nf6[["2... Nf6 !<br/>+0.4"]]:::main
    click Nf6 "#_Nf6_" "B00 · Pirc Defense"

    Nf6 --> Nc3[["3. Nc3 !<br/>+0.4"]]:::main
    click Nc3 "#_Nc3_" "B00 · Pirc Defense"

    Nc3 --> g6[["3... g6 !<br/>+0.5"]]:::main
    click g6 "https://github.com/onclemarcel/chess_flashcards/blob/main/e4_openings/B08_Pirc_Defense_Tabiya.md" "B07 · Pirc Defense"
    Nc3 --> e5[["3... e5<br/>+0.5"]]
