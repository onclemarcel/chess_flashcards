...
flowchart LR
    ...
    d6["1. e4 d6"]
    click d6 "#_initial_move_" "B07 · Pirc Defense"

    d6 --> d4[["2. d4 !<br/>+0.5"]]:::main
    click d4 "#_d4_" "B07 · Pirc Defense"

    d4 --> Nf6[["2... Nf6 !<br/>+0.4"]]:::main
    click Nf6 "#_Nf6_" "B07 · Pirc Defense"

    Nf6 --> Nc3[["3. Nc3 !<br/>+0.4"]]:::main
    click Nc3 "#_Nc3_" "B07 · Pirc Defense"

    Nc3 --> g6[["3... g6 !<br/>+0.5"]]:::main
    click g6 "#_g6_" "B07 · Pirc Defense"
    Nc3 --> e5[["3... e5<br/>+0.5"]]
    click e5 "#_e5_" "B07 · Pirc Defense"

    g6 --> f4[["4. f4 !<br/>+0.4"]]:::main
    click f4 "https://github.com/onclemarcel/chess_flashcards/blob/main/e4_openings/B09_Pirc_Austrian_Attack.md" "B09 · Pirc Defense: Austrian Attack"
    g6 --> Nf3g6[["4. Nf3<br/>+0.6"]]
    click Nf3g6 "https://github.com/onclemarcel/chess_flashcards/blob/main/e4_openings/B08_Pirc_Classical_System.md" "B08 · Pirc Defense: Classical Variation"
    g6 --> Be3[["4. Be3<br/>+0.5"]]
...
[![1. e4 d6](https://backscattering.de/web-boardimage/board.svg?fen=rnbqkbnr/ppp1pppp/3p4/8/4P3/8/PPPP1PPP/RNBQKBNR&lastMove=d7d6&coordinates=true&size=320)](https://lichess.org/analysis/standard/rnbqkbnr/ppp1pppp/3p4/8/4P3/8/PPPP1PPP/RNBQKBNR_w_KQkq_-_0_2)
...
*Online: bullet/blitz, 1800+ — 63.2 M games. Masters: 45 k games. [Open in the explorer](https://lichess.org/analysis/standard/rnbqkbnr/ppp1pppp/3p4/8/4P3/8/PPPP1PPP/RNBQKBNR_w_KQkq_-_0_2#explorer) — updated 2026-09-02*
<!-- lichess-stats:end -->
...
[![2. d4](https://backscattering.de/web-boardimage/board.svg?fen=rnbqkbnr/ppp1pppp/3p4/8/3PP3/8/PPP2PPP/RNBQKBNR&lastMove=d2d4&coordinates=true&size=320)](https://lichess.org/analysis/standard/rnbqkbnr/ppp1pppp/3p4/8/3PP3/8/PPP2PPP/RNBQKBNR_b_KQkq_d3_0_2)
...
*Online: bullet/blitz, 1800+ — 36.9 M games. Masters: 51 k games. [Open in the explorer](https://lichess.org/analysis/standard/rnbqkbnr/ppp1pppp/3p4/8/3PP3/8/PPP2PPP/RNBQKBNR_b_KQkq_d3_0_2#explorer) — updated 2026-09-02*
<!-- lichess-stats:end -->
...
[![2... Nf6](https://backscattering.de/web-boardimage/board.svg?fen=rnbqkb1r/ppp1pppp/3p1n2/8/3PP3/8/PPP2PPP/RNBQKBNR&lastMove=g8f6&coordinates=true&size=320)](https://lichess.org/analysis/standard/rnbqkb1r/ppp1pppp/3p1n2/8/3PP3/8/PPP2PPP/RNBQKBNR_w_KQkq_-_1_3)
...
[![3. Nc3](https://backscattering.de/web-boardimage/board.svg?fen=rnbqkb1r/ppp1pppp/3p1n2/8/3PP3/2N5/PPP2PPP/R1BQKBNR&lastMove=b1c3&coordinates=true&size=320)](https://lichess.org/analysis/standard/rnbqkb1r/ppp1pppp/3p1n2/8/3PP3/2N5/PPP2PPP/R1BQKBNR_b_KQkq_-_2_3)
...
*Online: bullet/blitz, 1800+ — 15.5 M games. Masters: 39 k games. [Open in the explorer](https://lichess.org/analysis/standard/rnbqkb1r/ppp1pppp/3p1n2/8/3PP3/2N5/PPP2PPP/R1BQKBNR_b_KQkq_-_2_3#explorer) — updated 2026-09-02*
<!-- lichess-stats:end -->

### Candidate moves

* [**3... g6**](#_g6_) (+0.5): the real Pirc Defense proper — masters' clear main try (49.1%) — covered below.
...
*Online: bullet/blitz, 1800+ — 10.1 M games. Masters: 20 k games. [Open in the explorer](https://lichess.org/analysis/standard/rnbqkb1r/ppp1pp1p/3p1np1/8/3PP3/2N5/PPP2PPP/R1BQKBNR_w_KQkq_-_0_4#explorer) — updated 2026-09-02*
<!-- lichess-stats:end -->
...
* [**4. f4**](https://github.com/onclemarcel/chess_flashcards/blob/main/e4_openings/B09_Pirc_Austrian_Attack.md) (+0.4): the ***Austrian Attack*** — masters' narrow plurality (25.0%), grabbing maximum space immediately. Live-confirmed its own code, **B09** — covered on its own card.
...
> 
> *Online: bullet/blitz, 1800+ — 1.4 M games. Masters: 4.3 k games. [Open in the explorer](https://lichess.org/analysis/standard/rnbqkb1r/ppp1pp1p/3p1np1/8/3PP3/2N1B3/PPP2PPP/R2QKBNR_b_KQkq_-_1_4#explorer) — updated 2026-09-02*
> <!-- lichess-stats:end -->
>
...
> ### 3... e5
>
> [![3... e5](https://backscattering.de/web-boardimage/board.svg?fen=rnbqkb1r/ppp2ppp/3p1n2/4p3/3PP3/2N5/PPP2PPP/R1BQKBNR&lastMove=e7e5&coordinates=true&size=280)](https://lichess.org/analysis/standard/rnbqkb1r/ppp2ppp/3p1n2/4p3/3PP3/2N5/PPP2PPP/R1BQKBNR_w_KQkq_e6_0_4)
>
> *... 3... e5*
>
> ```
...
>
> `eco.md`'s own entry separately calls this same position the *Ufimtsev-Pytel Variation* — a real naming divergence from Lichess's live "Czech Defense" tag at this exact leaf.
>
> [*Back to 3. Nc3*](#_Nc3_)
> [*Back to TOP*](#_TOP_)
