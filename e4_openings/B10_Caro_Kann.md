...
* **2. c4** (+0.4, 4.0% masters): the *Accelerated Panov Attack*, staking out the centre with the c-pawn instead.
* **2. d3** (+0.3, 2.5% masters): the *Breyer Variation*, a quiet, King's-Indian-Attack-flavoured setup.
