...
- [**... c6**](./e4_openings/B10_Caro_Kann.md) the Caro-Kann Defense, which keeps the light-squared bishop free, built out to the [Advance Variation](./e4_openings/B10_Caro_Kann.md#_e5_) tabiya after 2. d4 d5 3. e5.
...
- [**1. Nf3** The Zukertort Opening](./Nf3_openings/A04_Zukertort.md) (10.2% masters) — flexible, most lines transpose into 1. d4 or 1. c4 territory.
- [**1. c4** The English Opening](./c4_openings/A10_English.md) (6.9% masters) — a flank opening, often reached via a reversed Sicilian (1... e5) or Indian-style structures (1... Nf6), which itself transposes toward the King's Indian complex above after 2. Nc3 g6.
