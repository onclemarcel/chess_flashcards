...
- [**1. c4** The English Opening](./c4_openings/A10_English.md) (6.9% masters) — a flank opening reached from either side of the board. All five of Black's main replies are their own cards: the [Caro-Kann System (A11)](./c4_openings/A11_Caro_Kann_System.md) (1... c6), the [Agincourt Defense (A13)](./c4_openings/A13_Agincourt_Defense.md) (1... e6, forking deeper into the Neo-Catalan Declined, A14), the [Anglo-Indian Defense (A15)](./c4_openings/A15_Anglo_Indian_Defense.md) (1... Nf6, masters' barely-top choice), the [King's English Variation (A20)](./c4_openings/A20_Kings_English_Variation.md) (1... e5, a "reversed Sicilian"), and the [Symmetrical Variation (A30)](./c4_openings/A30_Symmetrical_Variation.md) (1... c5) — the Anglo-Indian itself transposing toward the King's Indian complex above after 2. Nc3 g6. Each front's own dominant reply is a full ECO-code jump to a further card: the Anglo-Indian's 2. Nc3 is the [Queen's Knight Variation (A16)](./c4_openings/A16_Anglo_Indian_Queens_Knight.md), and the King's English's 2. Nc3 is the [Reversed Sicilian (A21)](./c4_openings/A21_Kings_English_Reversed_Sicilian.md) — both confirmed live via the explorer's own ECO tag (a "wrong root code" bug, same class as A02/A04/B10, caught and fixed the same session it was built) and cross-checked against [chessopenings.com's ECO reference](https://chessopenings.com/eco/). A21's own main line forks further into the Two Knights (A22) and Reversed Closed Sicilian (A25) tabiyas.
