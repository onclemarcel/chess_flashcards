...
*Source: Speedrun: Back to 3000 ELO, game 3 (Naroditsky, 491 ELO on-screen) — full game context and the opening's own issues are covered as a cautionary NOTE/TIP on [C24 Bishop's Opening: Berlin Defense](https://github.com/onclemarcel/chess_flashcards/blob/main/e4_openings/C24_Bishop_Opening_Berlin_Defense.md#_Nxf7_blunder_); this card is only about the mating mechanism itself, verified move by move against the engine.*
